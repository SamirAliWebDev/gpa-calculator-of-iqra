...
const BRANDS = [
  { name: 'Iqra University', icon: GraduationCap },
  { name: 'IU Portal', icon: BookOpen },
  { name: 'IU GPA', icon: Calculator },
  { name: 'IU Library', icon: BookMarked },
  { name: 'IU Research', icon: Brain },
  { name: 'IU Excellence', icon: Trophy },
]
  ...
  return (
    <div className="relative w-full bg-zinc-950 text-white overflow-hidden font-sans">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse at 15% 50%, rgba(59, 130, 246, 0.15) 0%, transparent 50%),
            radial-gradient(ellipse at 85% 20%, rgba(16, 185, 129, 0.1) 0%, transparent 50%),
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pt-10 pb-4 sm:px-6 md:pt-14 md:pb-8 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">

          {/* Left Column */}
          <div className="lg:col-span-7 flex flex-col justify-center space-y-4 pt-2 lg:pt-8">

            {/* Badge */}
            <div className="animate-fade-in delay-100">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 backdrop-blur-md transition-colors hover:bg-white/10">
                <span className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-zinc-300 flex items-center gap-2">
                  Built for Iqra University
            ...
            <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
              The smartest way to monitor your performance at Iqra University.
              Calculate GPA across semesters, track your progress, and achieve your academic goals.
            </p>
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <div className="text-3xl font-bold tracking-tight text-white">4.00</div>
                    <div className="text-sm text-zinc-400">Maximum GPA</div>
                  </div>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-400">Calculation Accuracy</span>
                    <span className="text-white font-medium">100%</span>
                  </div>
                  <div className="h-2 w-full overflow-hidden rounded-full bg-zinc-800/50">
                    <div className="h-full w-[100%] rounded-full bg-gradient-to-r from-[#3B82F6] to-[#10B981]" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <StatItem value="11" label="Grades" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
                  <StatItem value="Instant" label="Results" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-8 backdrop-blur-xl">
              <h3 className="mb-6 px-8 text-sm font-medium text-zinc-400">Trusted by Iqra University Students</h3>
              ...
              >
                <div className="animate-marquee flex gap-12 whitespace-nowrap px-4">
                  {[...BRANDS, ...BRANDS, ...BRANDS].map((brand, i) => (
                    ...
                    >
                      <brand.icon className="h-6 w-6 text-white fill-current" />
